...
<html>
   ...
   <body>
         ...
         <header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="{{ route('home_index') }}"><img width="250" src="{{ asset('https://www.mykingdom.com.vn/cdn/shop/files/logo-254x76_1.png?v=1697473116&width=600') }}" alt="#" /></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="{{ route('frontend.news') }}">Cẩm nang  </a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="{{ route('frontend.contact') }}">Liên lạc </a>
                        </li>
                        <li class="nav-item">
                           @if($cartNum > 0)
               ...
               <div class="col-md-4">
                   <div class="full">
                      <div class="logo_footer">
                        <a href="#"><img width="210" src="{{ asset('https://www.mykingdom.com.vn/cdn/shop/files/logo-254x76_1.png?v=1697473116&width=600') }}" alt="#" /></a>
                      </div>
                      <div class="information_f">
                        <p><strong>Địa chỉ liên hệ:</strong> Văn phòng Hà Nội: Tầng 3 Tòa nhà BMM, KM2, Đường Phùng Hưng, Phường Phúc La, Quận Hà Đông, TP Hà Nội</p>
               ...
               <div class="col-md-8">
                  ...
                  <div class="col-md-7">
                     ...
                     <div class="widget_menu">
                        ...
                        <ul>
                           ...
                           <li><a href="{{ route('frontend.contact') }}">Liên lạc </a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-5">
                     <div class="widget_menu">
                        <h3>Bản tin</h3>
                        <div class="information_f">
                          <p>Đăng ký nhận bản tin của chúng tôi và nhận thông tin cập nhật về protidin.</p>
                        </div>
                        <div class="form_sub">
                           <form>
                              <fieldset>
      ...
      <!-- footer end -->
      <div class="cpy_">
         <p class="mx-auto">© 20255 All Rights Reserved By <a href="https://gokisoft.com">Zenky.com</a>
         </p>
      </div>
      <!-- jQery -->
